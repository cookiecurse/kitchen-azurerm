...
Credentials file or environment variables are still necessary with this configuration unless the kitchen deployment is from an Azure vm which is permissioned properly. Managed identities only target the kitchen vm. For more information, please see the [Configuration section](https://github.com/cookiecurse/kitchen-azurerm-readme/blob/6149fbbe1cc77611c8f045a398829f7bc05be81d/README.md#configuration).
